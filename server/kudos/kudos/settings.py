...
SECRET_KEY = 'django-insecure-_@7y4k+60h%u@gas%oqbc*rebo@!sddpp8j9pc@3qeymiz^+6z'
...
REST_FRAMEWORK = {
    ...
    'EXCEPTION_HANDLER': 'kudos_app.api.utils.custom_exception_handler.custom_exception_handler',
}
